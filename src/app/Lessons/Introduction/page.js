...
var accidentals = require('./accidentals.png');

export default function Fundamentals(){

    return (
        
        <div style={{ maxWidth: '800px', margin: 'auto', paddingLeft: 20, paddingRight: 20 }} >
            <div style={{ }} className="lesson-div">
                <h3>Notes</h3>
                ...
                <img src={require('./noteillustration.png')} alt="note illustration"/>
                ...
                <img src={clefs} style={{ width: '50%', height: '50%' }}/>
                ...
                <img src ={ledgerLines} style={{ width: '80%', height: '80%' }} />
                ...
                <img src ={accidentals} style={{ width: '50%', height: '50%' }}/>
            </div>
